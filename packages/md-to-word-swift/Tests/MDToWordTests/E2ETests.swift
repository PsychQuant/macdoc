...
final class E2ETests: XCTestCase {
    ...
    func testE2E_Tier3MetadataRestoration() throws {
        // Was QUARANTINED via XCTSkip (PsychQuant/macdoc#155); implemented
        // by PsychQuant/macdoc#206 — see `Tier3MetadataRestorer` for scope.
        var doc = WordDocument()
        doc.styles = Style.defaultStyles
        ...
        let restoredDoc = try reverse.convertMarkdown(md, metadata: metadata)
