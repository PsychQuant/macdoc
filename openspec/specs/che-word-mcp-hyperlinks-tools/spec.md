# che-word-mcp-hyperlinks-tools Specification

## Purpose

TBD - created by archiving change 'che-word-mcp-tables-hyperlinks-headers-builtin'. Update Purpose after archive.
