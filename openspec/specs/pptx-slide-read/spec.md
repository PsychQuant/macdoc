# pptx-slide-read Specification

## Purpose

Read slide content — traverse shape trees, extract text with formatting, identify placeholders, read images, tables, speaker notes, transitions, and shape visual properties.
