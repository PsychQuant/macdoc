# document-writing-profiles Specification

## Purpose

Define explicit, shared document formatting profiles for macdoc CLI and Word MCP, including safe template snapshots, preservation of document-owned formatting, configuration coexistence, and verifiable publication boundaries.
...
Manually synchronized from the completed `document-writing-profiles` change on 2026-09-10. See the [archive record](../../changes/archive/2026-09-10-document-writing-profiles/ARCHIVE-NOTE.md). Native Spectra indexing and archive identity bookkeeping were not performed.
