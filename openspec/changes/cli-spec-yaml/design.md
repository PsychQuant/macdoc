...
- `CLISpecError` covers: unsupported dump serialization version, malformed dump, empty version output, and the eight overlay failure classes named in the spec.
