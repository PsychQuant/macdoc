...
- [x] 6.3 [P] Remove the `rawChildren: [String]` ad-hoc fields from `Run`, `Paragraph`, `SectionProperties`, `Settings`; tree coverage subsumes them
...
- [x] 6.4 Update CHANGELOG with the v0.30 → v1.0 migration narrative; document the `Document.body.children = [...]` direct-assignment removal as a migration note
- [x] 6.5 Run the full ooxml-swift + che-word-mcp + macdoc CLI test matrix against v1.0; confirm zero regressions
...
- [x] 6.10 Tag and release `ooxml-swift v1.0.0`
