...
- [Risk] A response-size limit implemented after full buffering would not bound memory. → Mitigation: require the Anthropic transport to stop reading after 64 KiB and test the streaming limit with a stub transport.
